...
if( !function_exists("result_to_towf_new3") ){
	...
	function result_to_towf_new3($vDataResult, $ret,$errmsg,$sigInfo,$money,$num){
		$result_arr = array();
		$result_arr["resultcode"] = (string)$ret;
		$tmp_arr["errmsg"] = $errmsg;
		$tmp_arr["obj"] = $sigInfo;
...
if( !function_exists("result_to_towf_new2") ){
 ...
 function result_to_towf_new2($vDataResult, $ret,$errmsg,$sigInfo ,$num,$section){
	$result_arr = array();
	$result_arr["resultcode"] = (string)$ret;
	$tmp_arr["errmsg"] = $errmsg;
	$tmp_arr["obj"] = $sigInfo;
...
if( !function_exists("result_to_towf_new4") ){
 ...
 function result_to_towf_new4($vDataResult, $ret,$errmsg,$sigInfo ,$data){
	$result_arr = array();
	$result_arr["resultcode"] = (string)$ret;
	$tmp_arr["errmsg"] = $errmsg;
	$tmp_arr["obj"] = $sigInfo;
