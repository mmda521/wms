 ...
 *
 **/
class Ckquebao extends CI_Controller {
    ...
    * */
    ...
    {
         $this->load->view('wms/ckquebao');
		
    }
	public function ckquebao_report_send(){
...
//获取配置扫描类型
        $return = $soap->OUT_store_ensure($condition);
    ...
    * */
     ...
     public function edit()
    {
		...
		//PC::debug($outpre_head_id);
		$list['info'] = $this->outpre_head_model->get_data($condition);
	      
     // PC::debug($list);	
	    $this->load->view('wms/ckquebao_edit', $list);
	 ...
	 public function head_edit()
    {
     ...
     // PC::debug($list);	
	    $this->load->view('wms/ckquebao_head_edit', $list);
	...
	public function list_edit()
    {
	    ...
	    $this->load->view('wms/ckquebao_list_edit', $list);

    }
	public function quebao_chuku()
    {
        $store_bill_no = $this->input->get_post("store_bill_no");
	    ...
	    $this->load->view('wms/quebao_chuku', $list);
