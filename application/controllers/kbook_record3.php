...
class Kbook_record extends CI_Controller {
    ...
    * */
    ...
    {
         $this->load->view('wms/kbook_record_change');
    ...
    * */
     public function add()
    {      
         $this->load->view('wms/kbook_record_add');
    }
...
/**
    ...
    * */
    ...
    {
		 $condition = array();
		 $book_list = $this->kbook_record_model->get_list($condition);
		 echo("<table align='center'><tr><td padding ='2px'>账册id</td><td padding ='2px'>账册编号</td><td padding ='2px'>账册H2000号</td></tr>");
		 foreach($book_list as $book){
			 //print_r($book);
			 echo("<tr><td padding ='2px'>".$book['record_id']."</td><td padding ='2px'>".$book['eci_ems_no']."</td><td padding ='2px'>".$book['ems_no']."</td>");
		 }
		 echo("</table>");
	}
